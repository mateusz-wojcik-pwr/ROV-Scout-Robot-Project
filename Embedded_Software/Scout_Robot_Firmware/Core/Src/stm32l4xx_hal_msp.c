...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC3     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(GPIOC, MOT_A_CURR_ADC_Pin|MOT_B_CURR_ADC_Pin|MOT_C_CURR_ADC_Pin|MOT_D_CURR_ADC_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC5     ------> ADC2_IN14
    */
    HAL_GPIO_DeInit(GPIOA, BAT_CURR_CHRG_ADC_Pin|BAT_CURR_DISCH_ADC_Pin|V_BAT_ADC_Pin);

    HAL_GPIO_DeInit(GPIOC, LIGHT_SENS_ADC_Pin|V_CHRG_ADC_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA10     ------> TIM1_CH3
    */
    HAL_GPIO_DeInit(GPIOA, US_SENS_A_ECHO_Pin|US_SENS_B_ECHO_Pin|US_SENS_C_ECHO_Pin);
